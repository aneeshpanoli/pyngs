...
viridis_data = [[0.26700401, 0.00487433, 0.32941519], [
    0.26851048, 0.00960483, 0.33542652
                ...
                [0.27259384, 0.02556309,
                 0.35309303], [0.27380934, 0.03149748, 0.35885256], [
                     0.27495242, 0.03775181, 0.36454323
                 ], [0.27602238, 0.04416723,
                     0.37016418], [0.2770184, 0.05034437, 0.37571452], [
                         0.27794143, 0.05632444, 0.38119074
                     ], [0.27879067, 0.06214536,
                         0.38659204], [0.2795655, 0.06783587, 0.39191723], [
                         ...
                         ], [0.26657984, 0.2282621,
                             0.5143487], [0.2651445, 0.23295593, 0.5165993], [
                ...
                [0.22780192, 0.32659432,
                 0.546532], [0.2258633, 0.33080515,
                             0.54731353], [0.22392515, 0.334994, 0.54805291], [
...
def mbiasplot(positions, conv_dict, filename, fig_kw):
    ...
    methyl_values = [(top_strand_c[pos]['C'] + bot_strand_c[pos]['G']) /
                     (top_strand_c[pos]['Y'] + bot_strand_c[pos]['R'] +
                      top_strand_c[pos]['C'] + bot_strand_c[pos]['G'] + 0.1)
